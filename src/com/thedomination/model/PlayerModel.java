...
public class PlayerModel implements Serializable{
	 ...
	 * @return string values of object fields
	 *  */
	@Override
	public String toString() {
		return "PlayerModel [playerName=" + playerName + ", noOfArmyInPlayer=" + noOfArmyInPlayer + ", hasWonTerritory="
				+ hasWonTerritory + ", cardList=" + cardList + ", strategy=" + strategy + "]";
	}
